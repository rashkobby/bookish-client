...
const Home = () => {
  return (
    <div className=" opacity-75 bg-cover bg-center py-10 bg-[url('./src/assets/bg-image.jpg')]">
    
      <main className="container flex items-center leading-10 justify-center h-5/6 flex-col backdrop-blur-sm bg-white/30 w-2/3 m-auto py-10">
